...
Contributors: cstrosser, ianarmstrong
Tags: usage, admin, memory, security
...
Please leave requests and suggestions in the WordPress support forum.
...
= 0.9.2 =
* Updated the way scripts/styles are called. Old plugin had referenced the plugin by name instead of grabbing the full path.

= 0.9.2 =
* This is the official re-release of the plugin as an update from the original
* Changed default memory usage notification level from 32MB to 48MB (tcpmem-core.php:102).
* Added an entry for 48MB in the settings array (settings.php:235)
* Added entries up to 1024MB for high-volume websites (settings.php:235)
